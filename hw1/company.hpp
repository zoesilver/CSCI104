...
//returns largest company that a student is part of
  Company* largestCompany(Company* student);

//deletes companies and parents during destruction

  void deleteCompanyAndParents(Company* student);
